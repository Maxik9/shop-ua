      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="card">
          <div className="card-body">
            ...
            <label className="label mt-4">Опис (HTML редактор)</label>
            <RichTextEditor value={desc} onChange={setDesc} className="bg-white" />
            ...
            <div className="mt-6">
              <div className="text-sm text-slate-600 mb-2">Прев’ю опису</div>
              <div className="card">
                <div className="card-body">
